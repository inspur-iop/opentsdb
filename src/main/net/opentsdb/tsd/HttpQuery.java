...
final class HttpQuery extends AbstractHttpQuery {
  ...
  public String getQueryBaseRoute() {
    ...
    } else if(split[1].toLowerCase().equals("user")||split[1].toLowerCase().equals("auth")||split[1].toLowerCase().equals("metrics")){
      return "api/" + split[1].toLowerCase()+"/"+split[2].toLowerCase();
    }
    else{
