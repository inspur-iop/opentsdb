...
public class Config {
  ...
  /** tsd.core.authentication.enable */
  private boolean enable_auth = false;

  /** tsd.metrics.monitor.enable*/
  private boolean enable_monitor = false;
  ...
  */
  ...
  protected void setDefaults() {
    ...
    //authentication realted settings
    default_map.put("tsd.core.authentication.enable", "false");
    default_map.put("tsd.core.user.table", "tsdb-user");
    //monitor related settings
    default_map.put("tsd.metrics.monitor.enable", "false");
    default_map.put("tsd.storage.hbase.metrics_table", "tsdb-raw-metrics");
    default_map.put("tsd.storage.hbase.metrics_table_sencondly", "tsdb-metrics-second");
    default_map.put("tsd.storage.hbase.metrics_table_minutely", "tsdb-metrics-minute");
    default_map.put("tsd.storage.hbase.metrics_table_hourly", "tsdb-metrics-hour");
    default_map.put("tsd.monitor.zk_quorum", "localhost");
    default_map.put("tsd.monitor.parent.znode", "/tsdb");
  ...
  public void loadStaticVariables() {
    ...
    //
    enable_auth = this.getBoolean("tsd.core.authentication.enable");
    enable_monitor = this.getBoolean("tsd.metrics.monitor.enable");
  }
